<template>
  <b-container fluid>
    <b-row
      ...
      align-h="between"
      style="padding: 18px 115px; max-width: 100%; --bs-gutter-x: 0rem;">
    ...
    <b-row class="p-0 m-0">
      <b-col class="p-0 m-0">
        ...
        <div class="civic-10">
          <b-img fluid :src="require('../assets/img/header/civic_solo.png')" alt="Img Civic"> </b-img>
          <b-img fluid :src="require('../assets/img/header/civic_10.svg')" alt="Img Civic"> </b-img>
        </div>
      </b-col>
    </b-row>
  </b-container>
